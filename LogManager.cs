...
namespace TestMVC4App.Models
{
    ...
    public sealed class LogManager : IDisposable
    {
        ...
        /// </summary>
        public double StatsCountTotalOldIds { get; set; }

        private const string SUMMARY_BY_PROFILE_FILENAME = "QA_Reporting_Summary_OldIds.htm";
        ...
        private static Dictionary<int, bool> NoWarningNorErrorHappenedFlag_ByOldId;
