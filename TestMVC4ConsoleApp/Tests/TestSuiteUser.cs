...
namespace TestMVC4App.Models
{
    public sealed class TestSuiteUser : TestSuite
    {
        ...
        public override void RunAllTests()
        {
            ...
            {
                upiList = new HashSet<int>() { 13087115, 10098855, 10445859, 12445467, 10044421, 11842460, 10273683, 11228709, 12528002, 10410346, 10071485, 10934133, 12149599, 12641341, 10151776, 10290564, 11091604, 11472557, 12149599, 13132301, 10146455, 13157019, 10646102, 12192949, 10106216, 12268225, 11161032, 11832447, 11436806, 10736848 };
            }
