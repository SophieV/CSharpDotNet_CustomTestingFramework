...
namespace TestMVC4App.Models
{
    ...
    public class TestUnitUserBasicInfo : TestUnit
    {
        ...
        /// <returns></returns>
        /// <remarks>Special case where the new service needs the OldId -instead of the UserID - in the URL.</remarks>
        override protected string BuildNewServiceURL(string pageName)
        {
            ...
            return Container.newServiceURLBase + NewServiceURLExtensionBeginning + this.OldId + NewServiceURLExtensionEnding;
        }
        ...
        /// <param name="OldId">Old Identifier of the User.</param>
        ...
        protected override void RunAllSingleTests()
        {
            ...
            this.CompareAndLog_Test(EnumTestUnitNames.UserBasicInfo_OldId, "Comparing OldId", this.OldDataNodes, EnumOldServiceFieldsAsKeys.OldId.ToString(), this.newData.OldId.ToString());
